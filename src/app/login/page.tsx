...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-pink-600 via-purple-600 to-indigo-700 relative overflow-hidden items-center justify-center">
        ...
        <div className="relative z-10 text-center text-white px-12">
          ...
          <p className="text-lg text-pink-100 max-w-md">
            Lanjutkan membuat undangan pernikahan impian Anda bersama Coopid
          </p>
          <div className="mt-12 space-y-4 text-left max-w-sm mx-auto">
            {[
              { icon: "🎨", text: "Editor visual yang intuitif" },
              { icon: "👥", text: "Manajemen tamu otomatis" },
              { icon: "🎵", text: "Musik & galeri foto" },
            ].map((item) => (
              <div
                key={item.text}
      ...
      {/* Right Side - Form */}
      <div className="flex-1 flex items-center justify-center px-6 py-12 bg-gradient-to-b from-pink-50 via-white to-white">
        <div className="w-full max-w-md animate-fade-in">
          ...
          <div className="bg-white rounded-3xl shadow-soft border border-gray-100 p-8 lg:p-10">
            ...
            <p className="text-gray-500 mb-8">Masuk ke akun Coopid Anda</p>
